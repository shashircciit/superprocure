...
class UserTable extends Component {
  ...
  render() {
    ...
    console.log("shasdata",this.props.userdata)
        ...
        <div className="table-responsive">
          <table className="table dataTable with-image row-border hover custom-table" style={{ marginTop: 10 }}>
            ...
            <tbody>
              ...
              {this.props.userdata.map((dynamicData, Key) => {
                return (
                  <tr key={dynamicData._id} style={{ borderBottom: '1px solid red' }} className="animated fadeIn">
                    <td>
                      <div className="form-check form-check-flat">
                        <label className="form-check-label">
                          <input type="checkbox" className="form-check-input" name="foo" checked={(this.checkArray(dynamicData._id)) ? true : false} onClick={this.onCheckbox.bind(this, dynamicData.userId)} />
                          <i className="input-helper" />
                        </label>
                      </div>
                    </td>
                    <td >
                      <div className="thumb-img">
                        <img src="./assets/images/no-image-user.png" alt="pic" />
                      </div>
                    </td>
